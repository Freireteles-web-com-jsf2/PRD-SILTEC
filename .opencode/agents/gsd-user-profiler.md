...
<reference>
@D:/PRD-SILTEC/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/PRD-SILTEC/.opencode/get-shit-done/references/user-profiling.md` to load:
