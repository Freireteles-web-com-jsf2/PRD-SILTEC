...
<required_reading>
@D:/PRD-SILTEC/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/PRD-SILTEC/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/PRD-SILTEC/.opencode
                  → checks D:/PRD-SILTEC/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/PRD-SILTEC/.opencode/get-shit-done
                  → writes to D:/PRD-SILTEC/.opencode/get-shit-done/hooks/
...
@D:/PRD-SILTEC/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/PRD-SILTEC/.opencode/get-shit-done/references/common-bug-patterns.md
