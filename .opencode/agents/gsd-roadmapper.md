...
Reference full template: `D:/PRD-SILTEC/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/PRD-SILTEC/.opencode/get-shit-done/templates/state.md`.
