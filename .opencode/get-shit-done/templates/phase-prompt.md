...
<!-- For checkpoint task examples and patterns, see @D:/PRD-SILTEC/.opencode/get-shit-done/references/checkpoints.md -->
...
See `D:/PRD-SILTEC/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/PRD-SILTEC/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/PRD-SILTEC/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
