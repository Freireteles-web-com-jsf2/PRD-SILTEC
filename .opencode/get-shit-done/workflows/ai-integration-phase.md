...
<required_reading>
@D:/PRD-SILTEC/.opencode/get-shit-done/references/ai-frameworks.md
@D:/PRD-SILTEC/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/PRD-SILTEC/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-eval-planner.md for instructions.
