...
```
Agent(
  prompt="Read D:/PRD-SILTEC/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/PRD-SILTEC/.opencode/get-shit-done/templates/SECURITY.md`
