...
Key references:
- @D:/PRD-SILTEC/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @D:/PRD-SILTEC/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/PRD-SILTEC/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md" "D:/PRD-SILTEC/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/PRD-SILTEC/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @D:/PRD-SILTEC/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/PRD-SILTEC/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/PRD-SILTEC/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/PRD-SILTEC/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="D:/PRD-SILTEC/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    D:/PRD-SILTEC/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/PRD-SILTEC/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/PRD-SILTEC/.opencode/AGENTS.md
```
