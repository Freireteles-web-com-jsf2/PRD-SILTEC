...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/PRD-SILTEC/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/PRD-SILTEC/.opencode/agents/gsd-ui-checker.md for instructions.
