...
```
Agent(
  prompt="Read D:/PRD-SILTEC/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/PRD-SILTEC/.claude/get-shit-done/templates/SECURITY.md`
