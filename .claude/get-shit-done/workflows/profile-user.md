...
Key references:
- @D:/PRD-SILTEC/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/PRD-SILTEC/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/PRD-SILTEC/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md" "D:/PRD-SILTEC/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/PRD-SILTEC/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/PRD-SILTEC/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/PRD-SILTEC/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/PRD-SILTEC/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/PRD-SILTEC/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/PRD-SILTEC/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/PRD-SILTEC/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/PRD-SILTEC/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/PRD-SILTEC/.claude/CLAUDE.md
```
