...
<required_reading>
@D:/PRD-SILTEC/.claude/get-shit-done/references/user-story-template.md
@D:/PRD-SILTEC/.claude/get-shit-done/references/spidr-splitting.md
@D:/PRD-SILTEC/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/PRD-SILTEC/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/PRD-SILTEC/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/PRD-SILTEC/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
