...
<template>
@D:/PRD-SILTEC/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/PRD-SILTEC/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/PRD-SILTEC/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/PRD-SILTEC/.claude/get-shit-done/workflows/diagnose-issues.md
