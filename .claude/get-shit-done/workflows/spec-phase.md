...
```bash
INIT=$(node "D:/PRD-SILTEC/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/PRD-SILTEC/.claude/get-shit-done/templates/spec.md.
