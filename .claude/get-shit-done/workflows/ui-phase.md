...
```markdown
Read D:/PRD-SILTEC/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/PRD-SILTEC/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/PRD-SILTEC/.claude/agents/gsd-ui-checker.md for instructions.
